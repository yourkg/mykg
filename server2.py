...
from yottai.nna_v0_7 import NNA
from yottai.utils_v0_5 import *
from yottai.Sequential_v0_7 import Seq
...
while 1:
    ...
    for i in range(5):
        ...
        if i==4:
            data1+=str(class_names[inds[-1-i]])+"<br>Core:"+str(prob[inds[-1-i]])
        else:
            data1+=str(class_names[inds[-1-i]])+"<br>Core:"+str(prob[inds[-1-i]])+"<hr>"
#         if i==0 :
